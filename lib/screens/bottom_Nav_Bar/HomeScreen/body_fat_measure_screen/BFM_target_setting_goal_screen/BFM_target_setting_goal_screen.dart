...
class BFMTargetSettingGoalScreen extends StatefulWidget {
  const BFMTargetSettingGoalScreen({super.key});

  @override
  State<BFMTargetSettingGoalScreen> createState() => _BFMTargetSettingGoalScreenState();
}

class _BFMTargetSettingGoalScreenState extends State<BFMTargetSettingGoalScreen> with SingleTickerProviderStateMixin {
