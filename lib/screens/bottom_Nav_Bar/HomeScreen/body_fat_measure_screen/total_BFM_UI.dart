...
// class TotalBodyFatMeasureUi extends StatelessWidget {
//   const TotalBodyFatMeasureUi({super.key});
//
//   @override
...
//                     Image(image: AssetImage(ImagesUtils.kg,),height: 35,),
...
import 'BFM_start.dart';
class TotalBFMUi extends StatelessWidget {
  const TotalBFMUi({super.key});
              ...
              Column(
                ...
                children: [
                  ...
                  MyButton(navigateTo: (){
                    ...
                    // Navigator.push(context, MaterialPageRoute(builder: (context) => BodyFatMeasureStart(),));
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  TextWidget(
                    title: 'Spin body Fat Measure Program',
                    fontSize: 16,
                    textAlign: TextAlign.start,
                    textColor: ColorUtils.white,
                    fontWeight: FontWeight.w600,
