...
class CyclingStart extends StatefulWidget {
  const CyclingStart({super.key});

  @override
  State<CyclingStart> createState() => _CyclingStartState();
}

class _CyclingStartState extends State<CyclingStart> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(image: AssetImage(ImagesUtils.cyclingStartBackground),fit: BoxFit.fill)
        ),
        child: Container(
          height: screenHeight(context),
          width: screenWidth(context),
                          ...
                          GestureDetector(
                            onTap:(){
                              PersistentNavBarNavigator.pushNewScreen(
                                context,
                                screen: CyclingTargetSettingGoalScreen(),
                                withNavBar: false,
                              );
                            },
                            child: Container(
