...
class CyclingEditTimeScreen extends StatefulWidget {
  const CyclingEditTimeScreen({super.key});

  @override
  State<CyclingEditTimeScreen> createState() => _CyclingEditTimeScreenState();
}

class _CyclingEditTimeScreenState extends State<CyclingEditTimeScreen> {
  int inputIndex = 0;
  String rawInput = '';
  ...
  void saveValue() {
    ...
    // Save to Provider
    Provider.of<CyclingTimeProvider>(context, listen: false).setTime(formattedTime);
