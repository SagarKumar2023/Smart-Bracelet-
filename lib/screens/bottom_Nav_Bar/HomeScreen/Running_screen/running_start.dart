...
import 'Running_target_setting_goal_screen/Running_target_setting_goal_screen.dart';

class RunningStart extends StatefulWidget {
  const RunningStart({super.key});
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage(ImagesUtils.runningStartBackground),fit: BoxFit.cover)
        ),
        child: Container(
          height: screenHeight(context),
          width: screenWidth(context),
                          ...
                          GestureDetector(
                            onTap:(){
                              PersistentNavBarNavigator.pushNewScreen(
                                context,
                                screen: RunningTargetSettingGoalScreen(),
                                withNavBar: false,
                              );
                            },
                            child: Container(
