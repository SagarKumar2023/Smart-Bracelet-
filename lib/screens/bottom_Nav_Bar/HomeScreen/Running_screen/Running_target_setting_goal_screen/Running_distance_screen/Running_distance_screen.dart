...
import 'package:x_fitness/screens/bottom_Nav_Bar/HomeScreen/Running_screen/Running_target_setting_goal_screen/Running_distance_screen/Running_edit_distance_screen.dart';
...
class RunningDistanceScreen extends StatefulWidget {
  const RunningDistanceScreen({super.key});

  @override
  State<RunningDistanceScreen> createState() => _RunningDistanceScreenState();
}


class _RunningDistanceScreenState extends State<RunningDistanceScreen> {
  ...
  Widget buildDistanceTile(String distance, {String? label, EdgeInsets? padding}) {
    return Expanded(
      child: GestureDetector(
        onTap: () {
          Provider.of<RunningDistanceProvider>(context, listen: false).setDistance(distance);
        },
        child: Consumer<RunningDistanceProvider>(
  ...
  Widget build(BuildContext context) {
    return Consumer<RunningDistanceProvider>(
      builder: (context, distanceProvider, child) {
                  ...
                  GestureDetector(
                    onTap: () async {
                      final updatedDistance = await PersistentNavBarNavigator.pushNewScreen(
                        context,
                        screen: RunningEditDistanceScreen(),
                        withNavBar: false,
                      );
