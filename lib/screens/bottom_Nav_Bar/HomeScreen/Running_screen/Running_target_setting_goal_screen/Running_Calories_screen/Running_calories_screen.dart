...
import '../Running_time_screen/Running_edit_Time_screen.dart';
import 'Running_edit_Calories_screen.dart';

class RunningCaloriesScreen extends StatefulWidget {
  const RunningCaloriesScreen({super.key});

  @override
  State<RunningCaloriesScreen> createState() => _RunningCaloriesScreenState();
}

class _RunningCaloriesScreenState extends State<RunningCaloriesScreen> {
      ...
      child: GestureDetector(
        onTap: () {
          setState(() {
            ...
            Provider.of<RunningCaloriesProvider>(context, listen: false).setCalories(calories);
          });
        },
        child: Container(
  ...
  Widget build(BuildContext context) {
    return Consumer<RunningCaloriesProvider>(
      ...
      return Column(
        ...
        children: [
                ...
                GestureDetector(
                  onTap: () async {
                    PersistentNavBarNavigator.pushNewScreen(
                      context,
                      screen: RunningEditCaloriesScreen(),
                      withNavBar: false,
                    );
                  },
                  child: Container(
          ...
          MyButton(
            ...
            }, buttonName:'Start Running',buttonColor: ColorUtils.appGreen,),
