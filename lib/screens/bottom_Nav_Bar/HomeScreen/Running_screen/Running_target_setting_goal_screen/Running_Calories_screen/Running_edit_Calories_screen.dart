...
import 'Running_caloriesProvider.dart';

class RunningEditCaloriesScreen extends StatefulWidget {
  const RunningEditCaloriesScreen({super.key});

  @override
  State<RunningEditCaloriesScreen> createState() => _RunningEditCaloriesScreenState();
}

class _RunningEditCaloriesScreenState extends State<RunningEditCaloriesScreen> {
  ...
  void saveValue() {
    if (caloriesInput.isEmpty) {
      ...
      Provider.of<RunningCaloriesProvider>(context, listen: false).setCalories(caloriesInput);
