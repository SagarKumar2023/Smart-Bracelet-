...
class RunningEditTimeScreen extends StatefulWidget {
  const RunningEditTimeScreen({super.key});

  @override
  State<RunningEditTimeScreen> createState() => _RunningEditTimeScreenState();
}

class _RunningEditTimeScreenState extends State<RunningEditTimeScreen> {
  int inputIndex = 0;
  String rawInput = '';
  ...
  void saveValue() {
    ...
    // Save to Provider
    Provider.of<RunningTimeProvider>(context, listen: false).setTime(formattedTime);
