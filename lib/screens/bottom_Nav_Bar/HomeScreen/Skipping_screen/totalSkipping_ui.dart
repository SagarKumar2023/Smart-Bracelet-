...
// class TotalSkippingUi extends StatelessWidget {
//   const TotalSkippingUi({super.key});
//
//   @override
...
//                     VerticalSpace(height: 8),
//                     Text('00:00:00',style: TextStyle(fontSize: 25,color: ColorUtils.white.withOpacity(0.9)),),
//                   ],
//                 ),
//               ),
//             ),
...
import 'package:x_fitness/constant/images.dart';
import 'package:x_fitness/constant/spacer.dart';
import 'package:x_fitness/screens/bottom_Nav_Bar/HomeScreen/Skipping_screen/skipping_start.dart';
                ...
                children: [
                  ...
                  MyButton(navigateTo: (){
                    PersistentNavBarNavigator.pushNewScreen(
                      context,
                      screen: SkippingStart(),
                      withNavBar: false,
                    );
                    // Navigator.push(context, MaterialPageRoute(builder: (context) => SkippingStart(),));
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  TextWidget(
                    title: 'Spin Total Jumps Program',
                    fontSize: 16,
                    textAlign: TextAlign.start,
                    textColor: ColorUtils.white,
                    fontWeight: FontWeight.w600,
