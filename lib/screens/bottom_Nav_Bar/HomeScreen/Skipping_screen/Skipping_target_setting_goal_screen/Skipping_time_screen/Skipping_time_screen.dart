...
import 'Skipping_edit_Time_screen.dart';

class SkippingTimeScreen extends StatefulWidget {
  const SkippingTimeScreen({super.key});

  @override
  State<SkippingTimeScreen> createState() => _SkippingTimeScreenState();
}

class _SkippingTimeScreenState extends State<SkippingTimeScreen> {
  String? selectedTime;
      ...
      child: GestureDetector(
        onTap: () {
          setState(() {
            ...
            Provider.of<SkippingTimeProvider>(context, listen: false).setTime(distance);
          });
        },
        child: Container(
  ...
  Widget build(BuildContext context) {
    final savedTime = Provider.of<SkippingTimeProvider>(context).savedTime;
    return Column(
