...
class SkippingEditCaloriesScreen extends StatefulWidget {
  const SkippingEditCaloriesScreen({super.key});

  @override
  State<SkippingEditCaloriesScreen> createState() => _SkippingEditCaloriesScreenState();
}

class _SkippingEditCaloriesScreenState extends State<SkippingEditCaloriesScreen> {
  ...
  void saveValue() {
    if (caloriesInput.isEmpty) {
      ...
      Provider.of<SkippingCaloriesProvider>(context, listen: false).setCalories(caloriesInput);
