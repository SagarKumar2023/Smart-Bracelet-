...
class SkippingEditDistanceScreen extends StatefulWidget {
  const SkippingEditDistanceScreen({super.key});

  @override
  State<SkippingEditDistanceScreen> createState() => _SkippingEditDistanceScreenState();
}
class _SkippingEditDistanceScreenState extends State<SkippingEditDistanceScreen> {
