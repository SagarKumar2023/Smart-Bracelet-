...
import 'package:x_fitness/screens/bottom_Nav_Bar/HomeScreen/Running_screen/Running_target_setting_goal_screen/Running_time_screen/Running_edit_Time_screen.dart';
...
import 'package:x_fitness/screens/bottom_Nav_Bar/HomeScreen/Skipping_screen/Skipping_target_setting_goal_screen/Skipping_time_screen/Skipping_edit_Time_screen.dart';
...
import 'Skipping_edit_distance_screen.dart';

class SkippingDistanceScreen extends StatefulWidget {
  const SkippingDistanceScreen({super.key});

  @override
  State<SkippingDistanceScreen> createState() => _SkippingDistanceScreenState();
}


class _SkippingDistanceScreenState extends State<SkippingDistanceScreen> {
  ...
  Widget buildDistanceTile(String distance, {String? label, EdgeInsets? padding}) {
    return Expanded(
      child: GestureDetector(
        onTap: () {
          Provider.of<SkippingDistanceProvider>(context, listen: false).setDistance(distance);
        },
        child: Consumer<SkippingDistanceProvider>(
  ...
  Widget build(BuildContext context) {
    return Consumer<SkippingDistanceProvider>(
      builder: (context, distanceProvider, child) {
                  ...
                  GestureDetector(
                    onTap: () async {
                      final updatedDistance = await PersistentNavBarNavigator.pushNewScreen(
                        context,
                        screen: SkippingEditDistanceScreen(),
                        withNavBar: false,
                      );
