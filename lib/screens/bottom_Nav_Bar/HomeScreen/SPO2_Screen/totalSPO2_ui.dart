...
// class TotalSpo2Ui extends StatelessWidget {
//   const TotalSpo2Ui({super.key});
//
//   @override
...
//                     Text('0.0',style: TextStyle(fontSize: 30,color: ColorUtils.white.withOpacity(0.9)),),
//
//                   ],
//                 ),
//               ),
...
import 'package:x_fitness/constant/images.dart';
import 'package:x_fitness/constant/spacer.dart';
import 'package:x_fitness/screens/bottom_Nav_Bar/HomeScreen/spo2_screen/spo2_start.dart';
                ...
                children: [
                  ...
                  MyButton(
                    navigateTo: (){
                      ...
                      // Navigator.push(context, MaterialPageRoute(builder: (context) => Spo2Start(),));
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Image(image: AssetImage(ImagesUtils.time,),height:13,color:ColorUtils.white),
                  ...
                  Row(
                    children: [
                      Image(image: AssetImage(ImagesUtils.step,),height:13,color:ColorUtils.white),
                      HorizontalSpace(width:5),
                      TextWidget(
                        title: '4*30 reps',
                        fontSize: 14,
                ...
                children: [
                  Expanded(
                    child: Row(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Image(image: AssetImage(ImagesUtils.kg,),height:15,color: ColorUtils.appGreen),
