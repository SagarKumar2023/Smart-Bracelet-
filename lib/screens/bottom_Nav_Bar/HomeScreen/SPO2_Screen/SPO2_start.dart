...
class Spo2Start extends StatefulWidget {
  const Spo2Start({super.key});

  @override
  State<Spo2Start> createState() => _Spo2StartState();
}

class _Spo2StartState extends State<Spo2Start> {
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(image: AssetImage('Assets/background/Spo2bg.jpg'),fit: BoxFit.fill)
        ),
        child: Container(
          height: screenHeight(context),
          width: screenWidth(context),
